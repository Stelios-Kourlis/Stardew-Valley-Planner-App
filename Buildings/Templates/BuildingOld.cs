...
// public abstract class BuildingOld : TooltipableGameObject {
...
//     public abstract void LoadBuildingFromData(int x, int y, params string[] data);
...
//         if (GetBuildingController().isInsideBuilding.Key) return false;
