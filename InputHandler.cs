...
public class InputHandler : MonoBehaviour {
    ...
    void Update(){
        ...
        if (KeybindsForActionArePressed(KeybindHandler.Action.Settings)) GameObject.FindGameObjectWithTag("SettingsModal").GetComponent<SettingsModalController>().ToggleSettingsModal();
